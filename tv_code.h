...
typedef struct {
  ...
  real_T Gain1_j;                      /* '<S18>/Gain1' */
  real_T DotProduct;                   /* '<S11>/Dot Product' */
  real_T Sum1;                         /* '<S11>/Sum1' */
  real_T Gain1_i;                      /* '<S19>/Gain1' */
  real_T Gain1_g;                      /* '<S21>/Gain1' */
  real_T Gain1_h;                      /* '<S20>/Gain1' */
  ...
  real_T Gain1_l;                      /* '<S6>/Gain1' */
  real_T DotProduct_p;                 /* '<S9>/Dot Product' */
  real_T DotProduct1_d;                /* '<S9>/Dot Product1' */
  real_T DotProduct2;                  /* '<S9>/Dot Product2' */
  real_T DotProduct3;                  /* '<S9>/Dot Product3' */
  real_T regen_switch;                 /* '<S6>/regen_switch' */
  real_T Gain;                         /* '<S6>/Gain' */
  real_T MedianFilter;                 /* '<S2>/Median Filter' */
  real_T Divide;                       /* '<S4>/Divide' */
  real_T DotProduct_k;                 /* '<S13>/Dot Product' */
  real_T Switch;                       /* '<S9>/Switch' */
  real_T power_speed_limiter_switch[4];/* '<S3>/power_speed_limiter_switch' */
  real_T Gain_p;                       /* '<S20>/Gain' */
  real_T est_batt_current;             /* '<S4>/Sum1' */
  real_T Saturation3;                  /* '<S9>/Saturation3' */
  real_T div2;                         /* '<S13>/div2' */
...
typedef struct {
  dsp_simulink_MedianFilter_tv__T obj; /* '<S2>/Median Filter' */
...
struct P_tv_code_T_ {
  ...
  real_T whl_speed_rr_Value;           /* Expression: 0
                                        ...
                                        */
  real_T Gain_Gain_o;                  /* Expression: 1/4
  ...
  real_T Saturation1_LowerSat;         /* Expression: 0.3
                                        * Referenced by: '<S5>/Saturation1'
                                        */
  real_T Saturation_UpperSat_l;        /* Expression: 6
                                        * Referenced by: '<S5>/Saturation'
                                        */
  real_T Saturation_LowerSat_p;        /* Expression: -6
                                        * Referenced by: '<S5>/Saturation'
                                        */
  ...
  real_T Vdc_Value;                    /* Expression: 550
                                        ...
                                        */
  real_T Gain_Gain_d;                  /* Expression: 0.95
 ...
 * '<S4>'   : 'tv_code/The Best TorqueVectoring/TorqueVectoring2/Power limiter for car'
 ...
 * '<S12>'  : 'tv_code/The Best TorqueVectoring/TorqueVectoring2/Regenerative braking/Subsystem'
 * '<S13>'  : 'tv_code/The Best TorqueVectoring/TorqueVectoring2/Regenerative braking/Tmax'
 * '<S14>'  : 'tv_code/The Best TorqueVectoring/TorqueVectoring2/Torque distribution Tv/Fzfl'
 * '<S15>'  : 'tv_code/The Best TorqueVectoring/TorqueVectoring2/Torque distribution Tv/Fzfr'
 * '<S16>'  : 'tv_code/The Best TorqueVectoring/TorqueVectoring2/Torque distribution Tv/Fzrl'
 * '<S17>'  : 'tv_code/The Best TorqueVectoring/TorqueVectoring2/Torque distribution Tv/Fzrr'
 * '<S18>'  : 'tv_code/The Best TorqueVectoring/TorqueVectoring2/Torque distribution Tv/T_FL'
 * '<S19>'  : 'tv_code/The Best TorqueVectoring/TorqueVectoring2/Torque distribution Tv/T_FR'
 * '<S20>'  : 'tv_code/The Best TorqueVectoring/TorqueVectoring2/Torque distribution Tv/T_FR1'
 * '<S21>'  : 'tv_code/The Best TorqueVectoring/TorqueVectoring2/Torque distribution Tv/T_RL'
 */
